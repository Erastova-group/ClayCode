...
class Peaks:
    ...
    def get_peaks(
        ...
        if atom_types == "all":
            ...
            atom_types = [
                atom_type for atom_type in atom_types if atom_type in self.atom_types
            ]
        for atom_type in atom_types:
                    ...
                    for idx in self.idx_product:
                        try:
                            ...
                            while accept is False:
                                ...
                                plt.plot(x_vals, y_vals, color="black", label="density")
                                plt.scatter(
                                    x_vals[peaks],
                                    y_vals[peaks],
                                    color="red",
            ...
            if accept_query == "y":
                ...
                plt.close()
                outname = data._get_edge_fname(
                    atom_type=atom_type, name="edges", other=other
                )
                for x, y in self.get_iter(atom_type=atom_type):
                    plt.plot(x, y)
