...
def mod_traj(
    ...
    crdout = get_outname(infile=crdin, outstem=outstem, outfile_suffix=crdout_suffix)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-uc", type=str, help="Clay unit cell type", dest="clay_type", required=False
    )
    parser.add_argument(
        "-cfmt",
        type=str,
    ...
    parser.add_argument(
        "-ndx", default=False, help="Write index file.", dest="ndx", action="store_true"
    )
    parser.add_argument(
        "-start", type=int, help="First frame", dest="start", required=False, default=0
    )
    parser.add_argument(
        "-step", type=int, help="Frame step", dest="step", required=False, default=1
    )
    parser.add_argument(
        "-overwrite",
        action="store_true",
