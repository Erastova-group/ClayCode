...
import ClayCode.analysis.ph as ph
...
from ClayCode.core.lib import center_clay_universe, rename_il_solvent
from ClayCode.data.consts import AA, FF, MDP
...
def init_outpaths(
    ...
    """
    Get output ._gro and .top file names and create directory.
...
def add_aa(
    ...
    logger.info(f"_gro = {str(crdin.resolve())!r}")
